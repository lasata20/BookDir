...
var signup = exports.signup = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(name, email, role, password, confirmPassword) {
    var res;
      ...
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            ...
            (0, _alerts.showAlert)('error', 'Unexpected Error Logging Out!');
          }
          _context3.next = 12;
          break;
        case 8:
          ...
          console.error('Logout error:', _context3.t0.response); // Debugging log
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(data, type) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          url = type === 'password' ? 'http://localhost:3000/api/v1/users/updatePassword' : 'http://localhost:3000/api/v1/users/updateProfile';
          _context.next = 4;
          return (0, _axios.default)({
            method: 'PATCH',
            url: url,
        ...
        case 4:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', "".concat(type.toUpperCase(), " Update Success"));
          }
          _context.next = 11;
          break;
        case 8:
...
if (signupForm) signupForm.addEventListener('submit', /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
    var name, email, role, password, confirmPassword;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          e.preventDefault();
          ...
          _context.next = 8;
          return (0, _login.signup)(name, email, role, password, confirmPassword);
        case 8:
        case "end":
          return _context.stop();
      }
...
if (createBookForm) createBookForm.addEventListener('submit', /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(e) {
    var name, author, genre, description, imageFile, bookFile, formData, res;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          ...
          bookFile = document.getElementById('file').files[0]; // Create a FormData object to store form data
        ...
        case 21:
          ...
          (0, _alerts.showAlert)('error', _context3.t0.response.message || 'An error occurred');
        case 24:
        case "end":
          return _context3.stop();
      }
...
},{"./login":"login.js","./updateSetting":"updateSetting.js","./alerts":"alerts.js","axios":"../../node_modules/axios/index.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
